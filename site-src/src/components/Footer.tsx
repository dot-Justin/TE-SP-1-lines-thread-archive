...
const LINKS = [
  ...
  { label: 'BeagleBone glitcher', href: 'https://github.com/resinbeard/beaglebone-black-glitcher', note: 'murray\'s APPROTECT bypass rig' },
...
export function Footer() {
  return (
    <footer className="bg-te-black border-t border-te-border">
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-16 md:py-20">
        <div className="grid md:grid-cols-2 gap-12 md:gap-8">
          ...
          <div>
            ...
            <div className="mt-6 inline-block border border-te-orange/30 px-3 py-1.5 rounded">
              <span className="font-mono text-[0.6rem] text-te-orange tracking-[0.2em] uppercase">
